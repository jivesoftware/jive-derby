...
*************************************************/
 ...
 exports.route = function(req, res){
    ...
    var viewUI = sharedTileConfig["view-ui"];
    if (config["jive"]["tiles"][tileName]["view-ui"]) {
        viewUI = config["jive"]["tiles"][tileName]["view-ui"];
    } // end if

    var configData = {
      host : jive.service.serviceURL(),
      tileName : tileName,
      tileHeader : config["jive"]["tiles"][tileName]["tileViewHeader"]
    };

    res.render(viewUI,configData);
 };
