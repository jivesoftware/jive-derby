...
*************************************************/
 ...
 exports.route = function(req, res){
    ...
    var actionUI = sharedTileConfig["action-ui"];
    if (config["jive"]["tiles"][tileName]["action-ui"]) {
        actionUI = config["jive"]["tiles"][tileName]["action-ui"];
    } // end if

    var configData = {
      host : jive.service.serviceURL(),
      tileName : tileName,
      tileHeader : config["jive"]["tiles"][tileName]["tileActionHeader"]
    };

    res.render(actionUI,configData);
 };
